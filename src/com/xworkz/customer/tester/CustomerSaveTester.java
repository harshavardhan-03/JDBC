...
public class CustomerSaveTester {
	...
	public static void main(String[] args) {
		...
		CustomerDTO dto1 = new CustomerDTO("Pavan", "Chennai", "Bangalore", "Rajaji nagar, Hindipur", false,
		...
		CustomerDTO dto3 = new CustomerDTO("Bhanu", "Bangalore", "Vijayawada", "RK nagar, Anantapur", true, 143143141,
				Education.BE);
		CustomerDTO dto4 = new CustomerDTO("Hema", "Mangalore", "Chennai", "bus stand road, Anantapur", false, 143143144,
				Education.ME);
		CustomerDTO dto5 = new CustomerDTO("Nawaz", "Hydrabad", "Goa", "hariyura street, Anantapur", false, 143143145, Education.ME);
