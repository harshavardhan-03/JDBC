...
public class ScamInsertTester {
	...
	public static void main(String[] args) {
		...
		try (Connection connection = DriverManager.getConnection(url, username, password)) {
			...
			String query8 = "INSERT INTO scam VALUES(8,'CommonWealth Games Scam', 'Cheating and forgery', 2010, 'Suresh Kalmadi', '70,000crore', 'India', 'He was accused of corruption and malpractices')";
			...
			String query16 = "INSERT INTO scam VALUES(16,'2013 Chopper Scam', 'bribal scam', 2013, 'Finmeccanica CEO Giuseppe Orsi', '3600crore', 'India', 'bribes allegedly paid to secure the sale of 12 AW101 helicopters to india')";
			String query17 = "INSERT INTO scam VALUES(17,'CommonWealth Games Scam', 'Cheating and forgery', 2010, 'Suresh Kalmadi', '70,000crore', 'India', 'He was accused of corruption and malpractices')";
